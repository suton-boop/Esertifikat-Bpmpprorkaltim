...
<form method="POST"
      action="<?php echo e(route('admin.system.templates.store')); ?>"
          ...
          <div class="row g-3 mt-1">
            ...
            <div class="col-md-4">
              ...
              <div class="input-group shadow-sm">
                <input type="text"
                       ...
                       value="<?php echo e(old('code', 'TPL-' . strtoupper(Str::random(5)))); ?>"
            ...
            <div class="col-12">
              ...
              <textarea name="description"
                        class="form-control"
                        rows="3"
                        placeholder="Catatan internal template."><?php echo e(old('description')); ?></textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card card-soft mb-3">
        <div class="card-body">
          ...
          <textarea name="page_2_html"
                    class="form-control"
                    rows="8"
                    placeholder="Contoh: <table>...</table> atau {{ nama_kolom_excel }}"><?php echo e(old('page_2_html')); ?></textarea>
          <div class="form-text">
      ...
      <div class="card card-soft">
        <div class="card-body">
          ...
          <textarea id="settingsJson"
                    ...
                    rows="18"
                    placeholder='{"fields":{"name":{"x":0,"y":0,"font":18}}}'><?php echo e(old('settings', $defaultSettingsJSON)); ?></textarea>
        </div>
      </div>
    </div>
  </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\esertifikatv1\resources\views/templates/create.blade.php ENDPATH**/ ?>