      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h2 class="mb-0 fw-bold <?php echo e($pendingJobs > 0 ? 'text-warning' : 'text-dark'); ?>"><?php echo e(number_format($pendingJobs)); ?></h2>
          </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h2 class="mb-0 fw-bold <?php echo e($failedJobs > 0 ? 'text-danger' : 'text-dark'); ?>"><?php echo e(number_format($failedJobs)); ?></h2>
          </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h2 class="mb-0 fw-bold text-success"><?php echo e(number_format($totalCertificatesGenerations)); ?></h2>
          </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
          <div>
            ...
            <h2 class="mb-0 fw-bold text-primary"><?php echo e(number_format($totalTteSigned)); ?></h2>
          </div>
