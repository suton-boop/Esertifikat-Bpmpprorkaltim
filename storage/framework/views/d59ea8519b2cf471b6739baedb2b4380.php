            ...
            <div class="card-body p-4 p-md-5 text-center">
                ...
                <form action="<?php echo e(route('public.verify.process')); ?>" method="POST" class="d-flex justify-content-center">
                    ...
                    <div class="input-group input-group-lg shadow-sm rounded-3 overflow-hidden" style="max-width: 550px; border: 1px solid #e2e8f0;">
                        ...
                        <input type="text" name="certificate_number" class="form-control border-0 py-3" placeholder="Masukkan Nomor Sertifikat di sini..." required autofocus value="<?php echo e(old('certificate_number')); ?>">
