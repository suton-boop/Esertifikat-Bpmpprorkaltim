            ...
            <div class="card card-soft border-0" style="background: linear-gradient(135deg, #0d6efd 0%, #00d2ff 100%); color: white; border-radius: 20px;">
                <div class="card-body p-5 position-relative overflow-hidden">
                    <div style="position: relative; z-index: 2;">
                        <h2 class="fw-bold mb-2">Selamat Datang, <?php echo e(auth()->user()->name); ?> 👋</h2>
                        ...
                        <a href="<?php echo e(route('admin.certificates.index')); ?>" class="btn btn-light rounded-pill px-4 py-2 fw-semibold shadow-sm text-primary">Lihat Sertifikat</a>
                    </div>
                    <!-- Decorative Element -->
        ...
        <div class="col-md-4">
            <div class="card card-soft h-100 py-3" style="border-radius: 18px; border-left: 5px solid #0d6efd;">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold mb-0 display-6"><?php echo e(number_format($totalEvents)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-soft h-100 py-3" style="border-radius: 18px; border-left: 5px solid #198754;">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold mb-0 display-6"><?php echo e(number_format($totalParticipants)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card card-soft h-100 py-3" style="border-radius: 18px; border-left: 5px solid #ffca2c;">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold mb-0 display-6"><?php echo e(number_format($totalCertificates)); ?></h2>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var statusOptions = {
            series: [<?php echo e($approved); ?>, <?php echo e($signed); ?>, <?php echo e($pending); ?>, <?php echo e($rejected); ?>],
            chart: {
                type: 'donut',
                height: 350,
                fontFamily: 'inherit'
        ...
        var eventNames = <?php echo json_encode($certPerEvent->pluck('event.name')->map(function($name) { return \Illuminate\Support\Str::limit($name, 15); })->toArray()); ?>;
        var eventCounts = <?php echo json_encode($certPerEvent->pluck('total')->toArray()); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\esertifikatv1\resources\views/dashboard.blade.php ENDPATH**/ ?>