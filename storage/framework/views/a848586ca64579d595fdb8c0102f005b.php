...
<?php $__env->startSection('title','Dashboard TTE'); ?>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        <a class="btn btn-outline-primary shadow-sm" href="<?php echo e(route('admin.tte.signing.index')); ?>">
            <i class="fa-solid fa-signature me-1"></i> Antrean Signing
        </a>
        <a class="btn btn-outline-secondary shadow-sm" href="<?php echo e(route('admin.tte.signers.index')); ?>">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden" style="background: linear-gradient(135deg, #FF9A9E 0%, #FECFEF 100%);">
            <div class="card-body position-relative z-1 text-white p-4">
                ...
                <h2 class="display-4 fw-bolder mb-0 text-white drop-shadow"><?php echo e(number_format($pendingApproved ?? 0)); ?></h2>
            ...
            <div class="card-footer bg-white bg-opacity-25 border-0 px-4 py-3">
                <a href="<?php echo e(route('admin.tte.signing.index')); ?>" class="text-white text-decoration-none fw-semibold d-flex justify-content-between align-items-center">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden" style="background: linear-gradient(135deg, #12c2e9 0%, #c471ed 50%, #f64f59 100%);">
            <div class="card-body position-relative z-1 text-white p-4">
                ...
                <h2 class="display-4 fw-bolder mb-0 text-white drop-shadow"><?php echo e(number_format($signedToday ?? 0)); ?></h2>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-4 h-100 overflow-hidden position-relative bg-white">
            <div class="card-body p-4 d-flex flex-column justify-content-center">
                ...
                <div>
                    <h2 class="display-5 fw-bolder mb-1 text-dark"><?php echo e(number_format($activeSigners ?? 0)); ?></h2>
                    <h6 class="fw-semibold text-muted mb-0">Signer (Akun TTE) Aktif</h6>
                </div>
                <div class="mt-3">
                    <a href="<?php echo e(route('admin.tte.signers.index')); ?>" class="btn btn-sm btn-light border-secondary border-opacity-25 rounded-pill fw-semibold text-primary">Kelola Signer <i class="fa-solid fa-chevron-right ms-1" style="font-size: 10px;"></i></a>
                </div>
    ...
    <div class="col-md-12">
        <div class="card border-0 shadow-sm rounded-4">
            ...
            <div class="card-body p-4">
               <?php if(isset($pendingApproved) && $pendingApproved > 0): ?>
                   <div class="alert alert-warning border-warning border-opacity-50 bg-warning bg-opacity-10 rounded-4 d-flex align-items-center p-3 mb-0">
                       ...
                       <div>
                           <h6 class="fw-bold text-dark mb-1">Terdapat <?php echo e($pendingApproved); ?> Dokumen Mengantre!</h6>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\esertifikatv1\resources\views/admin/tte/dashboard.blade.php ENDPATH**/ ?>