...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'E-Sertifikat BPMP Kaltim'); ?></title>
...
<body>
        ...
        <div class="container container-main">
            <nav class="navbar navbar-expand-lg navbar-dark navbar-gov">
                <a class="brand-logo navbar-brand m-0" href="/">
                    <img src="<?php echo e(asset('images/Asset 2@4x.png')); ?>" alt="Kemendikdasmen">
                </a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
      <ul class="navbar-nav gap-3">
        ...
        <li class="nav-item">
          <a class="nav-link fw-semibold" href="<?php echo e(route('public.verify.form')); ?>">Verification</a>
        </li>
        <li class="nav-item">
          <a class="nav-link fw-semibold" href="<?php echo e(route('public.search')); ?>">Cari Sertifikat</a>
        </li>
         <li class="nav-item">
          <a class="nav-link fw-semibold" href="https://bpmpkaltim.kemendikdasmen.go.id/">BPMPKALTIM</a>
        </li>
        <li class="nav-item">
          <a class="nav-link fw-semibold" href="<?php echo e(route('login')); ?>">Login</a>
        </li>
      </ul>
    </div>
    ...
    <div class="breadcrumb-wrap">
        <div class="container container-main py-3">
            <span class="breadcrumb-pill">
                ...
                <?php echo $__env->yieldContent('breadcrumb', 'Beranda'); ?>
            </span>
        </div>
    </div>
    ...
    <footer class="footer-public text-white py-4 mt-5 position-relative overflow-hidden">
        ...
        <div class="container container-main position-relative z-1">
            ...
            <div class="border-top border-white border-opacity-25 mt-4 pt-3 text-center" style="font-size:13px; color:#e9ecef;">
                &copy; <?php echo e(date('Y')); ?> Balai Penjaminan Mutu Pendidikan (BPMP) Provinsi Kalimantan Timur. All rights reserved.
            </div>
        </div>
    </footer>
...
</html><?php /**PATH C:\laragon\www\esertifikatv1\resources\views/public/layout.blade.php ENDPATH**/ ?>