...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', 'E-Sertifikat'); ?></title>
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
  <div class="container">
    ...
    <a class="navbar-brand d-flex align-items-center gap-3" href="/">
      <img src="<?php echo e(asset('images/logo-kemendikdasmen.png')); ?>" 
           alt="Kemendikdasmen"
  ...
  <div class="breadcrumb-wrap">
    <div class="container py-3">
      <div class="d-inline-flex align-items-center gap-2 bg-danger text-white px-3 py-2 rounded-3">
        <span class="fw-semibold"><?php echo $__env->yieldContent('breadcrumb', 'Home'); ?></span>
      </div>
    </div>
  </div>
...
<?php /**PATH C:\laragon\www\esertifikatv1\resources\views/public/layout.blade.php ENDPATH**/ ?>