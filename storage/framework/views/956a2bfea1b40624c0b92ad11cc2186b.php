...
<?php $__env->startSection('title', 'Beranda Publik - E-Sertifikat'); ?>
<?php $__env->startSection('breadcrumb', 'Beranda'); ?>
...
<div class="row align-items-center g-5 py-5">
    <div class="col-lg-6">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
            <a href="<?php echo e(route('public.search')); ?>" class="btn btn-primary btn-lg px-4 me-md-2 fw-semibold d-flex align-items-center gap-2">
                <i class="fa-solid fa-magnifying-glass"></i> Cari Sertifikat
            </a>
            <a href="<?php echo e(route('public.verify.form')); ?>" class="btn btn-outline-danger btn-lg px-4 fw-semibold d-flex align-items-center gap-2">
